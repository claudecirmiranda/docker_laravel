...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Você pode gerar o token atráves do sistema de autenticação interno da Nagem.',
    ],

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<INTRO
Esta documentação provê informações sobre o uso do micro serviço de rastreamento de pedidos da Nagem.
...
Você pode alternar a linguagem utilizada através das abas no canto superior direito (ou pelo menu de navegação no canto superior esquerdo no mobile).
</aside>
INTRO
    ,
    ...
    'logo' => '//static.nagem.com.br/util/artefatos/asset/n/9821596550697/img/layout/logoNagem.png',
